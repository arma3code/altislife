...
class Life_HUD_nameTags {
	...
	class controls
	{
		...
		class p111 : BaseIcon {idc = BaseIconID + 110;};
		class p112 : BaseIcon {idc = BaseIconID + 111;};
		class p113 : BaseIcon {idc = BaseIconID + 112;};
		class p114 : BaseIcon {idc = BaseIconID + 113;};
		class p115 : BaseIcon {idc = BaseIconID + 114;};
		class p116 : BaseIcon {idc = BaseIconID + 115;};
		class p117 : BaseIcon {idc = BaseIconID + 116;};
		class p118 : BaseIcon {idc = BaseIconID + 117;};
		class p119 : BaseIcon {idc = BaseIconID + 118;};
		class p120 : BaseIcon {idc = BaseIconID + 119;};
	};
};