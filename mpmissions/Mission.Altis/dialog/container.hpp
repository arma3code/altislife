class UnionDialogContainer
{
	...
	class Controls
	{
		...
		class TakeItem : RscButtonUC
		{
			idc = 4109;
			text = "Взять";			
			onButtonClick = "[] spawn UnionClient_system_houseTakeItem;";
		...
		class StoreItem : RscButtonUC
		{
			idc = 4108;
			text = "Положить";			
			onButtonClick = "[] spawn UnionClient_system_houseStoreItem;";
		...
		{
			idc = 4107;
			onLBSelChanged = "_this call UnionClient_system_containerMenuFilter";
			x = 0.303569 * safezoneW + safezoneX;
